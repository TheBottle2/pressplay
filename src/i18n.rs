...
pub fn t(lang: Lang, key: &'static str) -> &'static str {
    match (lang, key) {
        ...
        (Lang::Tr, "about_credit") => "TheBottle2 tarafından geliştirilmiştir.",
        ...
        (Lang::En, "about_credit") => "Developed by TheBottle2.",
        ...
        (Lang::De, "about_credit") => "Entwickelt von TheBottle2.",
        ...
        (Lang::Fr, "about_credit") => "Développé par TheBottle2.",
        ...
        (Lang::Es, "about_credit") => "Desarrollado por TheBottle2.",
        ...
        (Lang::Pt, "about_credit") => "Desenvolvido por TheBottle2.",
        ...
        (Lang::It, "about_credit") => "Sviluppato da TheBottle2.",
        ...
        (Lang::Nl, "about_credit") => "Ontwikkeld door TheBottle2.",
        ...
        (Lang::Pl, "about_credit") => "Autor: TheBottle2.",
        // ---------- misc ----------
        (Lang::Tr, "ready") => "Hazır",
        (Lang::En, "ready") => "Ready",
        ...
        // ---------- speed + record filter + recent files ----------
        (Lang::Tr, "speed_label") => "Hız:",
        (Lang::Tr, "speed_apply") => "Hızı Uygula",
        (Lang::Tr, "rec_keyboard") => "Klavye",
        (Lang::Tr, "rec_mouse") => "Fare",
        (Lang::Tr, "recent_title") => "Son dosyalar:",
        (Lang::Tr, "recent_empty") => "Henüz son dosya yok.",
        (Lang::Tr, "recent_missing") => "(bulunamadı)",
        (Lang::En, "speed_label") => "Speed:",
        (Lang::En, "speed_apply") => "Apply Speed",
        (Lang::En, "rec_keyboard") => "Keyboard",
        (Lang::En, "rec_mouse") => "Mouse",
        (Lang::En, "recent_title") => "Recent files:",
        (Lang::En, "recent_empty") => "No recent files yet.",
        (Lang::En, "recent_missing") => "(missing)",
        (Lang::De, "speed_label") => "Tempo:",
        (Lang::De, "speed_apply") => "Tempo übernehmen",
        (Lang::De, "rec_keyboard") => "Tastatur",
        (Lang::De, "rec_mouse") => "Maus",
        (Lang::De, "recent_title") => "Zuletzt verwendet:",
        (Lang::De, "recent_empty") => "Keine zuletzt verwendeten Dateien.",
        (Lang::De, "recent_missing") => "(fehlt)",
        (Lang::Fr, "speed_label") => "Vitesse :",
        (Lang::Fr, "speed_apply") => "Appliquer la vitesse",
        (Lang::Fr, "rec_keyboard") => "Clavier",
        (Lang::Fr, "rec_mouse") => "Souris",
        (Lang::Fr, "recent_title") => "Fichiers récents :",
        (Lang::Fr, "recent_empty") => "Aucun fichier récent.",
        (Lang::Fr, "recent_missing") => "(manquant)",
        (Lang::Es, "speed_label") => "Velocidad:",
        (Lang::Es, "speed_apply") => "Aplicar velocidad",
        (Lang::Es, "rec_keyboard") => "Teclado",
        (Lang::Es, "rec_mouse") => "Ratón",
        (Lang::Es, "recent_title") => "Archivos recientes:",
        (Lang::Es, "recent_empty") => "Sin archivos recientes.",
        (Lang::Es, "recent_missing") => "(no encontrado)",
        (Lang::Pt, "speed_label") => "Velocidade:",
        (Lang::Pt, "speed_apply") => "Aplicar velocidade",
        (Lang::Pt, "rec_keyboard") => "Teclado",
        (Lang::Pt, "rec_mouse") => "Rato",
        (Lang::Pt, "recent_title") => "Ficheiros recentes:",
        (Lang::Pt, "recent_empty") => "Sem ficheiros recentes.",
        (Lang::Pt, "recent_missing") => "(em falta)",
        (Lang::It, "speed_label") => "Velocità:",
        (Lang::It, "speed_apply") => "Applica velocità",
        (Lang::It, "rec_keyboard") => "Tastiera",
        (Lang::It, "rec_mouse") => "Mouse",
        (Lang::It, "recent_title") => "File recenti:",
        (Lang::It, "recent_empty") => "Nessun file recente.",
        (Lang::It, "recent_missing") => "(mancante)",
        (Lang::Nl, "speed_label") => "Snelheid:",
        (Lang::Nl, "speed_apply") => "Snelheid toepassen",
        (Lang::Nl, "rec_keyboard") => "Toetsenbord",
        (Lang::Nl, "rec_mouse") => "Muis",
        (Lang::Nl, "recent_title") => "Recente bestanden:",
        (Lang::Nl, "recent_empty") => "Geen recente bestanden.",
        (Lang::Nl, "recent_missing") => "(ontbreekt)",
        (Lang::Pl, "speed_label") => "Prędkość:",
        (Lang::Pl, "speed_apply") => "Zastosuj prędkość",
        (Lang::Pl, "rec_keyboard") => "Klawiatura",
        (Lang::Pl, "rec_mouse") => "Mysz",
        (Lang::Pl, "recent_title") => "Ostatnie pliki:",
        (Lang::Pl, "recent_empty") => "Brak ostatnich plików.",
        (Lang::Pl, "recent_missing") => "(brak)",
